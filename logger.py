...
class Logger(object):
    ...
    def output(self, args):
        ...
        if not os.path.exists(f'results/{args.dataset}/{args.method}'):
            os.makedirs(f'results/{args.dataset}/{args.method}')
        datetime_now = datetime.now().strftime("%Y%m%d-%H%M%S")
        filename = f'results/{args.dataset}/{args.method}/final_encoder_{args.encoder}.tau_{args.tau}.K_{args.K}.{datetime_now}.txt'
